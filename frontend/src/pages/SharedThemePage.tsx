...
export const SharedThemePage: React.FC = () => {
  ...
  // Check if the user already has this theme installed (matched by source_share_token).
  const existingTheme = themeCtx.customThemes.find(t => t.source_share_token === token);
