...
export const PROVIDER_MODELS: Record<string, { label: string; value: string }[]> = {
  ...
  xai: [
    { label: 'Grok 4.1 (Reasoning)', value: 'grok-4-1-fast-reasoning' },
    { label: 'Grok 4.1 (Fast)',       value: 'grok-4-1-fast-non-reasoning' },
    { label: 'Grok Code',             value: 'grok-code-fast-1' },
  ],
  mistral: [
    { label: 'Mistral Large',    value: 'mistral-large-latest' },
    { label: 'Mistral Small',    value: 'mistral-small-latest' },
    { label: 'Magistral Medium', value: 'magistral-medium-2509' },
    { label: 'Magistral Small',  value: 'magistral-small-2509' },
    { label: 'Codestral',        value: 'codestral-latest' },
  ],
  google: [
    { label: 'Gemini 3.1 Pro',        value: 'gemini-3.1-pro-preview' },
    { label: 'Gemini 3.1 Flash',      value: 'gemini-3.1-flash-preview' },
